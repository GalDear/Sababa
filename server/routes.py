...
from api.settings import getSettings,getUserInfo,updateUserInfo
...
settings.route("/api/getUserinfo", methods=["GET"])(getUserInfo)
settings.route("/api/updateUserInfo", methods=["POST"])(updateUserInfo)